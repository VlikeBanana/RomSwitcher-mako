...
/dev/block/platform/msm_sdcc.1/by-name/cache        /system         ext4    ro,nosuid,nodev,barrier=1,data=ordered                                                    wait
#/dev/block/platform/msm_sdcc.1/by-name/system      /cache          ext4    noatime,nosuid,nodev,barrier=1,data=ordered                     wait,check
/dev/block/platform/msm_sdcc.1/by-name/userdata     /1stdata        ext4    noatime,nosuid,nodev,barrier=1,data=ordered,noauto_da_alloc     wait,check,encryptable=/dev/block/platform/msm_sdcc.1/by-name/metadata
